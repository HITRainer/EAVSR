...
class ETHDataset(BaseDataset):
	def __init__(self, opt, split='train', dataset_name='ETH'):
		super(ETHDataset, self).__init__(opt, split, dataset_name)
		if self.root == '':
	...
	def _getitem_train(self, idx):
		...
		# raw_combined, dslr_image, coord = self._crop(raw_combined, dslr_image, self.coord)
		raw_combined, dslr_image, coord = augment(raw_combined, dslr_image, self.coord)
